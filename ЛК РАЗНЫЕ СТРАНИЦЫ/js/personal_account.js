...
$(document).ready(function() {
    ...
    // При наведении на выпадающее меню стрелка библиотеки переворачивается
    // После возвращается в исходное
    $('#libraryMenu').hover(
        function() {
    ...
    // При наведении на Библиотеку элемент поворачивается на 180 градусов
    // После возвращается в исходное
    $('#library').hover(
        function() {
            // Поворачиваем элемент на 180 градусов при наведении
